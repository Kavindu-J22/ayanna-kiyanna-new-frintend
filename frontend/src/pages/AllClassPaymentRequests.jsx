          ...
          <Grid container spacing={2} sx={{ mb: 3 }}>
            <Grid item xs={12} sm={6} md={2.4}>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card sx={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white', width: '200px', height: '150px'}}>
            ...
            <Grid item xs={12} sm={6} md={2.4}>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card sx={{ background: 'linear-gradient(135deg, #ffa726 0%, #ff9800 100%)', color: 'white', width: '200px', height: '150px' }}>
                  <CardContent sx={{ textAlign: 'center', py: 2 }}>
                    <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', mx: 'auto', mb: 1 }}>
                      <PendingActions />
                    </Avatar>
            ...
            <Grid item xs={12} sm={6} md={2.4}>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card sx={{ background: 'linear-gradient(135deg, #4caf50 0%, #388e3c 100%)', color: 'white', width: '200px', height: '150px' }}>
                  <CardContent sx={{ textAlign: 'center', py: 2 }}>
                    <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', mx: 'auto', mb: 1 }}>
                      <CheckCircle />
                    </Avatar>
            ...
            <Grid item xs={12} sm={6} md={2.4}>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card sx={{ background: 'linear-gradient(135deg, #f44336 0%, #d32f2f 100%)', color: 'white', width: '200px', height: '150px' }}>
                  <CardContent sx={{ textAlign: 'center', py: 2 }}>
                    <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', mx: 'auto', mb: 1 }}>
                      <Cancel />
                    </Avatar>
            ...
            <Grid item xs={12} sm={6} md={2.4}>
              <motion.div whileHover={{ scale: 1.02 }}>
                <Card sx={{ background: 'linear-gradient(135deg, #9c27b0 0%, #673ab7 100%)', color: 'white', width: '200px', height: '150px' }}>
                  <CardContent sx={{ textAlign: 'center', py: 2 }}>
                    <Avatar sx={{ bgcolor: 'rgba(255,255,255,0.2)', mx: 'auto', mb: 1 }}>
                      <TrendingUp />
                    </Avatar>
