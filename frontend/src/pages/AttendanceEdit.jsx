              ...
              {formData.studentAttendance.some(student =>
                ...
                >
                  <Typography variant="h6" sx={{
                    ...
                    🎯 විශේෂ සටහන - අලුත් හෝ ඉවත් වූ සිසුන් පිළිබද
                  </Typography>
                  ...
                  <Typography variant="body1" sx={{
                    ...
                    📋 <strong>මෙම පැමිණීම් පත්‍රිකාවේ "අලුත් හෝ ඉවත් වූ සිසුන්" ද ඇතුළත් වේ.</strong>
                  </Typography>
                  ...
                  <Box sx={{
                    ...
                    <Typography variant="body2" sx={{
                      ...
                      🔄 <strong>ස්වයංක්‍රීය ගණනය කිරීම:</strong> පද්ධතිය අලුත් හෝ ඉවත් වූ සිසුන්ගේ පැමිණීම් විශ්ලේෂණ ස්වයංක්‍රීයව සිදු කරයි.
