...
const EditAssignment = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate(`/admin-assignments/${assignment.classId._id}`);
      }, 2000);
        ...
        <Container maxWidth="lg">
          ...
          <Paper elevation={3} sx={{
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
              <IconButton onClick={() => navigate(`/admin-assignments/${assignment.classId._id}`)} color="primary">
                <ArrowBack />
              </IconButton>
              <Typography variant="h4" fontWeight="bold" sx={{
                fontFamily: '"Gemunu Libre", "Noto Sans Sinhala", sans-serif'
              }}>
                පැවරුම සංස්කරණය කරන්න
              </Typography>
            </Box>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', height: '100%' }}>
                          <FormControlLabel
                            ...
                            sx={{
                              ...
                              px: 2,
                              py: 1,
                              bgcolor: formData.isPublished ? 'success.light' : 'warning.light'
                            }}
                          />
                        </Box>
                      </Grid>
                  ...
                  <Paper elevation={1} sx={{ p: 3, bgcolor: 'grey.50', borderRadius: 2 }}>
                    <Box sx={{ display: 'flex', gap: 3, justifyContent: 'center' }}>
                      <Button
                        variant="outlined"
                        size="large"
                        onClick={() => navigate(`/admin-assignments/${assignment.classId._id}`)}
                        sx={{ minWidth: 150 }}
                      >
                        අවලංගු කරන්න
                      </Button>
                      ...
                      >
                        {saving ? 'යාවත්කාලීන කරමින්...' : 'පැවරුම යාවත්කාලීන කරන්න'}
                      </Button>
                    </Box>
                  </Paper>
                </Grid>
