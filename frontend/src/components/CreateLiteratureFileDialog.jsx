...
const CreateLiteratureFileDialog = ({ open, onClose, folderId, onFileCreated }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://ayanna-kiyanna-new-backend.onrender.com/api/literature/files',
        {
          ...formData,
      ...
      <DialogContent sx={{ pt: 2 }}>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <Paper
            ...
            onClick={() => document.getElementById('literature-file-upload').click()}
          >
            <input
              id="literature-file-upload"
              type="file"
              multiple
              accept="image/*,.pdf"
              style={{ display: 'none' }}
            ...
            <UploadIcon sx={{ fontSize: 48, color: '#ff6b6b', mb: 1 }} />
            <Typography
              variant="body1"
              sx={{
                fontFamily: '"Noto Sans Sinhala", "Yaldevi", sans-serif',
...
export default CreateLiteratureFileDialog;
